	...
	'central-asia' => [
		...
		'offices' => [
			[
				...
				'company' => '(Kazakhstan, Kyrgyzstan, Uzbekistan, Tajikistan, Turkmenistan, Azerbaijan)',
				'address' => [ '58, Otrarskaya st.', 'Almaty, Kazakhstan' ],
				'phone'   => '+7 776 911 55 11',
				'email'   => 'office@acrylicon-asia.com',
				'web'     => 'www.acrylicon.asia',
			],
		],
	],
	...
	'united-kingdom' => [
		...
		'offices' => [
			...
			[
				...
				'address' => [ 'Warrington House Farm', 'Olney, Buckinghamshire, MK46 4HN' ],
				'phone'   => '+44 (0) 7577 434733',
				'email'   => 'leeroberts@acrylicon.com',
				'web'     => '',
			],
			[
				'name'    => 'AcryliCon UK — South West',
				'company' => 'Trusted Flooring Solutions Limited',
				'address' => [ 'Ascott-under-Wychwood', 'Oxford, OX7 6AU' ],
				'phone'   => '+44 (0) 1865 920 690',
				'email'   => 'kester.harvey@trustedflooringsolutions.com',
