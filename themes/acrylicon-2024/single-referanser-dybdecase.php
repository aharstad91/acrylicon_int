<?php
/**
 * Template for referanser with type: dybdecase
 * Rich content with image gallery (Swiper) + structured metadata
 */
...
<main class="max-w-screen-2xl mx-auto px-5 md:px-20 pt-12 md:pt-20 lg:pt-44 pb-8">
	...
	<?php
	// Image gallery (ACF repeater)
	if ( have_rows( 'referance_images_repeater' ) ) : ?>
	<div class="mt-10 mb-10">
		<div class="swiper mySwiper">
			<div class="swiper-wrapper">
				<?php while ( have_rows( 'referance_images_repeater' ) ) : the_row();
